...
export default function WhoAmISection() {
  return (
    ...
    >
      <h2 className="font-black text-3xl text-black text-center mt-12">
        ...
        <div className="border-black w-30 h-30 lg:w-50 lg:h-50 overflow-hidden relative rounded-full cursor-pointer">
          <div className="relative w-full h-full group">
            <Image
              ...
              alt="Portrait of Piraisudan R, full stack engineer"
              fill
      ...
      <div id="skills" className="text-black mt-9 scroll-mt-[10vh]">
        <h2 className="border-b text-left font-black text-2xl pb-4">SKILLS</h2>
        <FilterComponent
